...
public class Chatts_Tests  extends AppCompatActivity {
   ...
   // private ProgressBar proogress_;
    ...
    public void selectAll(){
        ...
        try{
            ...
            String mode = "users";
            C_Adapter_Final adapter = new C_Adapter_Final(Chatts_Tests.this,body_l,date_l,type,fetch,url_l,mode);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            String[] dates = new String[date_l.size()];
                            dates = date_l.toArray(dates);
                            String[] body = new String[body_l.size()];
                            body = body_l.toArray(body);
                            Long[] lg = new Long[type.size()];
                            lg = type.toArray(lg);
                            String[] url2 = new String[date_l.size()];
                            url2 = url_l.toArray(url2);
                            final String[] finalBody = body;
                            final Long[] finalLg = lg;
